...
import 'package:omkar_development/Demo/Demowalk.dart';
...
class _Login2State extends State<Login2> {
  ...
  Future<Login2?> login(
    ...
    if (isDeviceConnected = await InternetConnectionChecker().hasConnection) {
      ...
      try {
        ...
        // print(response.body.isEmpty == true);
  ...
  Future<void> check() async {
    SharedPreferences pree1 = await SharedPreferences.getInstance();

    seen = await pree1.setBool("seenon", true);
    // SharedPreferences pree125 = await SharedPreferences.getInstance();

    // // seen21 = await pree125.setBool("seenon2", false);
    // seen21 = await pree125.setBool("seenon", false);
    // print(seen21);
  }
